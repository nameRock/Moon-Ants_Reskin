...
namespace CrazyGames
{
    public class CrazyAds : Singleton<CrazyAds>
    {
        ...
        public delegate void AdStartedCallback();

        private AdStartedCallback onAdStarted;
...
#region adbreak
        ...
        public void beginAdBreakRewarded(AdStartedCallback adStartedCallback = null, AdBreakCompletedCallback completedCallback = null,
            AdErrorCallback errorCallback = null)
        {
            beginAdBreak(adStartedCallback, completedCallback, errorCallback, CrazyAdType.rewarded);
        }

        public void beginAdBreak(AdStartedCallback adStartedCallback = null, AdBreakCompletedCallback completedCallback = null, AdErrorCallback errorCallback = null,
        ...
        private void AdStarted()
        {
            ...
            IsRunningAd = true;
            if (onAdStarted != null) onAdStarted.Invoke();
        }
